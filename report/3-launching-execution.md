...
```mermaid
graph TD
    Invio[Invio richiesta di cambiamento]
    Valutazione[Valutazione della richiesta]
    Discussione[Discussione della richiesta]
    Approvazione[Approvazione del cambiamento]
    Rifiuto[Rifiuto della richiesta]
    Invio --> Valutazione
    Valutazione -->|Impatto positivo| Discussione
    Valutazione -->|Impatto negativo| Rifiuto
    Discussione -->|Impatto positivo| Approvazione
    Discussione -->|Impatto negativo| Rifiuto
```
